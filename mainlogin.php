...
<br>
<br>
<a style="color:blue;"href="/custlogin.php">Customer Login</a>
<br>
<br>
<br>
<br>
<a style="color:blue;"href="/emplogin.php">Employee Login</a>
...
//        // connected:
//        // check if the tables exist. if not create them. (using executePlainSQL and not exists)
//        $customers = executePlainSQL("select 1 from customers LIMIT 1");
//
//        if (customers == FALSE) {
//            //it doesn't exist so make it and load some tuples
//            echo "<br> creating new table customers <br>"
//            executePlainSQL("create table customers (custid number, name varchar2(30), address varchar2(50), email varchar2(30), password varchar2(16), primary key (custid))");
//            OCICommit($db_conn);
//        }
//        
