...
<form method="POST" action="emp-account-update.php?emp_email=<?php echo $email;?>">
    <div>
...
// 				printCustomer($result);
    ...
    if (array_key_exists('UpdateEmpAccount', $_POST)) {
		...
		elseif(array_key_exists('back_to_browse', $_POST)){
			header("location: emp_browse.php?emp_email=" . $email);
		}
